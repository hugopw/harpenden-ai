...
export const interventions: Intervention[] = [
  ...
  },
  {
    ...
    example: "Run annually in Harpenden to track whether we&rsquo;re pulling everyone along or leaving groups behind.",
    accent: "meadow",
  },
  {
    name: "Council Engagement Diagnostic",
    kicker: "Diagnostic",
    what: "Assesses how well a council&rsquo;s decisions and communications are landing with residents, and where AI can close the gap.",
